...
public abstract class Captcha extends Randoms {
    ...
    public static final String FONT_PATH = "/captcha/font/";
    ...
    public void setFont(int font, int style, float size) throws IOException, FontFormatException {
        this.font = Font.createFont(Font.TRUETYPE_FONT, getClass().getResourceAsStream(FONT_PATH + FONT_NAMES[font])).deriveFont(style, size);
    }
